...
class AnalyticalPieChart @JvmOverloads constructor(
    ...
    private var textAmountSize: Float = context.spToPx(22)
    ...
    /**
     * Метод отрисовки расположение суммы на Canvas.
     */
    private fun sizeTextAmountNumber() = getWidthOfAmountText(amountForm(totalAmount), amountTextPaint)
    ...
    private fun drawText(canvas: Canvas) {
        canvas.drawText(
            ...
            circleCenterX - sizeTextAmountNumber().width() / 2,
            textAmountY,
            amountTextPaint
        )
        canvas.drawText(
